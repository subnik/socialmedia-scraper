            ...
            properties: {
                user: {
                    ...
                    properties: {
                        ...
                        is_business_account: { type: 'boolean', required: false },
                        business_category_name: { type: [ 'string', 'null' ], required: false },
                        business_email: { type: [ 'string', 'null' ], required: false },
                        business_phone_number: { type: [ 'string', 'null' ], required: false },
                        business_address_json: { type: [ 'string', 'null' ], required: false },
